		...
		template = [
			...
			},
			{
				...
				submenu: [
					...
					{ label: 'Next Tab',                accelerator: 'Command+}',           enabled: false, click: negative.selectNextTab },
					{ label: 'Previous Tab',            accelerator: 'Command+{',           enabled: false, click: negative.selectPreviousTab },
					{ label: 'Next Tab and Resize',     accelerator: 'Alt+Command+}', enabled: false, click: negative.selectNextTabAndResizeWindowToFitImage },
					{ label: 'Previous Tab and Resize', accelerator: 'Alt+Command+{',  enabled: false, click: negative.selectPreviousTabAndResizeWindowToFitImage },
					{
						label: 'Move',
						submenu: [
