		...
		template = [
			...
			},
			{
				...
				submenu: [
					...
					MENU_SEPARATOR,
					{ label: 'Actual Size',     accelerator: 'Command+0',         enabled: false, click: negative.zoomIn },
					{ label: 'Zoom in',         accelerator: 'Shift+Command+=',   enabled: false, click: negative.zoomIn },
