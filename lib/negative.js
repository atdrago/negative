...
module.exports = {
	...
	captureRegionBehindWindow() {
		...
		if (focusedWindow) {
			...
			focusedWindow.setTitle('Negative - Capture');

			negativeScreenshot(newImageX, newImageY, newImageWidth, newImageHeight)
				.then(function (base64Uri) {
					focusedWindow.setTitle('Negative');
					focusedWindow.webContents.executeJavaScript(`
						negative.frameController.setImageAndSize('${base64Uri}', ${newImageWidth}, ${newImageHeight});
